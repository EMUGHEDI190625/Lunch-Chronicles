  ...
  return (
    <>
      <div className="navbar">
        ...
        <nav className="nav">
          <div className="logo">
            <img src="/E-Commerce site/Images/Lunch Chronicles.jpg" alt="Lunch Chronicles" />
                                 ...
                                 {customer_status === "new_customer" && (
                                    <section id="newCustomerSection">
                                        ...
                                        <div className="checkout-form">
                                            ...
                                            <label className="first">Phone
                                                <span> *</span>
                                            </label>
                                            <br></br>
                                            <label className="second">Address
                                                <span> *</span>
                                            </label>
                                            <div className="checkout-field">
                                            <input
                                            ...
                                            <label className="first">Order Price</label>
                                            <br></br>
                                            <label className="second">Email
                                                <span> *</span>
                                            </label>
                                            <div className="checkout-field">
                                                <input
                                ...
                                {customer_status === "other" && (
                                    <section id="otherCustomerSection">
                                          <div className="checkout-form">
                                                ...
                                                <br></br>
                                                <br></br>
                                                <textarea  name="ordername"></textarea>

                                                <label className="first">Order Price</label><br></br>
                                                <label className="second">Email
                                                    <span> *</span>
                                                </label>
                                                <div className="checkout-field">
        ...
        <div class="footer_container">
            ...
            <div class="footer_section">
                ...
                <div class="footer_section_contact" id="contact">
                    <a href="tel08102764355">08102764355</a>
                    <a href="mailto:">kenoyeikata@gmail.com</a>
                </div>
            </div>
            <div class="social">
                <strong>Stay in Touch with us</strong>
                <br></br>
                <a href="https://wa.me/+2348102764355?text=Good%20day" target="_blank" rel="noreferrer" 
                    title="Click on this link to direct you to my WhatsApp page. Note: Do not delete the defualt message." 
                    id="icon">
                    <i class="fa-brands fa-whatsapp"></i>
                </a>
                <a class=" m-2" href="https://github.com/190625" rel="noreferrer" >
