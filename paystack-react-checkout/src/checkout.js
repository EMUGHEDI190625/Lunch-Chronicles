    ...
    <>
      <div className="navbar">
        ...
        <div class="container_button logo">
            <button class="button-toggle" onclick="togglenavbar()" title="togle nav bar"><i className="fa-solid fa-bars"></i></button>
            <img src="/E-Commerce/Images/Lunch Chronicles.jpg" alt="Lunch Chronicles business logo"></img>
        ...
        <section class="main" id="form">
            ...
            <section class="parent" id="parent">
                ...
                <div class="child">
                    <div id="topform">
                        <section>
                            <p>The puropse for this form is to collect your details for processing your order and to store it 
                                in our 
                                <strong> Data Base </strong>
                                also for you to check your order in 
                                <strong> Customer view. </strong>
                                <br></br>
                                <strong> Note: </strong> Your answer based on the following questions are between you and us.
                            </p>
                        </section>
                    </div>
                 </div>
                <form onSubmit={(e) => e.preventDefault()}>
                    ...
                    <p>The radio input field that have the text 
                        <b> Other </b>
                            ...
                            <b> Custmoer Status </b>
                            question. <br></br>
                            <strong class="strong">Note: Selecting your custmoer status. This will determine which section is 
                                show next.
                            </strong>
                            <br></br>
                            ...
                            at a customer.
                                ...
                                <label className="customer_status_label">kindly select Customer Status</label>
                                 ...
                                 {customer_status === "new_customer" && (
                                    <section id="newCustomerSection">
                                        ...
                                        <h3>New Custmoer</h3>
                                        <p>Note this section is not mandating but we love you to fill this to know if we are 
                                            lacking in anyway after rating us and give your comment. Thank you.
                                        </p>
                                        <p>How did you come across this bussiness and Please why?</p>
                                        <label for="instagram"> Instagram </label>
                                        <input type="checkbox" name="instagram"></input>
                                        <label for="facebook"> Facebook </label>
                                        <input type="checkbox" name="source" value="facebook"></input>
                                        <label for="word_of_mouth"> Word of Mouth </label>
                                        <input type="checkbox" name="source" value="Word of Mouth"></input>
                                        <label for="google_search"> Google Search </label>
                                        <input type="checkbox" name="source" value="Google Search"></input>
                                        <label for="past_customer"> Past Custmoer </label>
                                        <input type="checkbox" name="source" value="Past Custmoer"></input><br></br>
                                        <label for="event_market_stall"> Event or Market Stall </label>
                                        <input type="checkbox" name="source" value="facebook">
                                        {/* <br></br> */}
                                        </input>
                                        <br></br>
                                        <label for="bussiness_recommendation">Recommendation From Another Bussiness</label>
                                        ...
                                        <input type="checkbox" name="source" value="YouTube or TikTok Video"></input>
                                        <label for="flyer_poster_brochure">flyer/poster/brochure</label>
                                        <input type="checkbox" name="source" value="flyer/poster/brochure" id=""></input>
                                        <label for="other">Others</label>
                                        <input type="checkbox"  name="source" value="other"></input>
                                        <br></br>
                                        <p>Please if you select other from the previous question can you specify and from the 
                                            options about can you give reason/reasons why do you come to use our service based 
                                            on your ansnwer above?
                                        </p>
                                        <textarea  name="newCustomerOtherReason" placeholder="Leave your comment here..."></textarea>
                                        <p>
                                            kindly rate our UI (<strong class="strong">Lunch Chronicles</strong> design). 1: 
                                            Poor (1 star) 2: Fair (2 stars) 3: Good (3 stars) 4: very Good (4 stars)  5: 
                                            Excellent (5 stars)
                                        </p>
                                        <p>
                                        ...
                                        <div className="checkout-form">
                                            ...
                                            <p className="test">Below are Your Orders Details from Your Cart</p>
                                            <div></div>
                                            <strong>Note:</strong> <span style={{color : "black"}}>From the <strong> Order Category </strong> to <strong>Order Price</strong> are not mandating because if you selected order form the Restaurants page and that your order show/diplay in the cart that mean you may not fill those fileds unless the meals are not display in the Restaurants page but in the menu in that page</span>
                                            <br></br>
                                            <br></br>
                                ...
                                {customer_status === "returning_customer" && (
                                    ...
                                    <p>Please Note this section is not mandating but we love you to fill this to know if we are
                                         lacking in anyway. Thank you.
                                    </p>
                                    <p>
                                        kindly rate your previous delivery experience. 1:  Poor (1 star) 2: Fair (2 stars) 3: 
                                        Good (3 stars) 4: very Good (4 stars)  5: Excellent (5 stars)
                                    </p>
                                    <select name="experience_rating">
                                        <option value="1">1 - Poor</option>
                                        <option value="2">2 - Fair</option>
                                    ...
                                    <p>
                                        Would you like to leave any comment or suggestion based on your experience with our 
                                        service? E.g. you can start with why you rate us based on the above question.
                                    </p>
                                    <textarea name="returningComment" placeholder="Leave your comment here..."></textarea>
                                    <div className="checkout-form">
                                            <h3>Personal Order Details</h3>
                                            <label className="first">First Name
                                                <span> *</span>
                                            ...
                                            <strong>Note:</strong> <span style={{color : "black"}}>From 
                                                the <strong> Order Category </strong> to <strong>Order 
                                                    Price</strong> are not mandating because if you 
                                                    selected order form the Restaurants page and that your
                                                     order show/diplay in the cart that mean you may not 
                                                     fill those fileds unless the meals are not display in
                                                      the Restaurants page but in the menu in that page</span>
                                            <br></br>
                                            <br></br>
                                            <label className="check">Order Category</label>
                                            <br></br>
